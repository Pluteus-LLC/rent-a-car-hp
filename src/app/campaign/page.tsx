  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        {/* Campaign Banner */}
        <div className="bg-orange-100 dark:bg-orange-900 border-2 border-orange-300 dark:border-orange-700 rounded-2xl p-6 mb-12 text-center shadow-md">
          <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
            利用後購入キャンペーン実施中！ <span className="text-base md:text-lg font-normal text-gray-700 dark:text-gray-300">（2025年12月31日まで）</span>
          </p>
        </div>
        ...
        {/* Main Message */}
        <div className="bg-orange-50 dark:bg-orange-900 border-2 border-orange-500 rounded-xl p-8 mb-12">
          <p className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white text-center mb-4">
        ...
        {/* Benefits Section */}
        <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-8 mb-8 shadow-lg">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center border-b dark:border-gray-700 pb-4">
            ○特典内容○
          </h3>
        ...
        {/* Period Section */}
        <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-8 mb-8 shadow-lg">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 text-center border-b dark:border-gray-700 pb-4">
            ○期間○
          </h3>
          <p className="text-xl text-gray-900 dark:text-white text-center font-semibold">
            2025年12月31日まで
          </p>
        </div>

        {/* Terms Section */}
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-8 shadow-lg">
      ...
      {/* Footer */}
      <footer className="bg-gray-100 dark:bg-gray-800 border-t border-gray-300 dark:border-gray-700 mt-16 py-8">
